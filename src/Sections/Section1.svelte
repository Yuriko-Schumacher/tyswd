  ...
  <Scroller top="{0}" bottom="{1}" threshold="{0.5}" bind:index bind:offset bind:progress>
                ...
                {#each data as d}
                  <circle
                    ...
                    stroke-opacity="{index == 0 ? 0
                      : index == 1 ? 0.1
                      : index >= 2 ? aScale(d.fatalities)
                      : index == 3 ? d.fatalities >= 200 ? 1 : aScale(d.fatalities)
                      : index == 4 ? d.fatalities >= 200 && d.pct_fixed < 25 ? 1 : aScale(d.fatalities)
                      : index == 5 ? d.fatalities >= 200 && d.pct_fixed > 25 ? 1 : aScale(d.fatalities)
                      : index == 6 ? d.pct_fixed >= 150 || d.pct_fixed < 25 ? aScale(d.fatalities) : aScale(d.fatalities)
                      : aScale(d.fatalities)}"
                    fill="{index <= 2 ? "white"
                      : index == 3 ? d.fatalities >= 200 ? "yellow" : "white"
                      : index == 4 ? d.fatalities >= 200 && d.pct_fixed < 25 ? "yellow" : "white"
                      : index == 5 ? d.fatalities >= 200 && d.pct_fixed > 25 ? "yellow" : "white"
                      : index == 6 ? d.pct_fixed >= 150 || d.pct_fixed < 25 ? "yellow" : "white"
                      : "white"}"
    ...
    <div class="scroller foreground" slot="foreground">
      ...
      <section data-section-id="5" class="step">
        <div class="step-text">
          <p>
            Two of these four occurred between the new and earliest signs of waxing crescent, when the moon grows from 0% to 25% illumination.
          </p>
        </div>
      </section>
      <section data-section-id="6" class="step">
        <div class="step-text">
          <p>
            The other two occurred in close proximity to the new moon, but during the final transition from waning crescent back to its origin.
          </p>
        </div>
      </section>
