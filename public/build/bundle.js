...
var app = (function () {
    ...
    const file$8 = "src/Sections/Title.svelte";
    ...
    const file$7 = "src/Sections/Intro.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$7, 5, 2, 33);
    			add_location(li0, file$7, 9, 4, 90);
    			add_location(li1, file$7, 15, 8, 293);
    			add_location(li2, file$7, 18, 8, 480);
    			add_location(ul0, file$7, 14, 6, 280);
    			add_location(li3, file$7, 12, 4, 177);
    			add_location(ul1, file$7, 8, 2, 81);
    			add_location(article, file$7, 4, 0, 21);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "node_modules/@sveltejs/svelte-scroller/Scroller.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svelte_scroller_background, file$6, 173, 2, 3978);
    			...
    			add_location(svelte_scroller_background_container, file$6, 172, 1, 3880);
    			set_custom_element_data(svelte_scroller_foreground, "class", "svelte-xdbafy");
    			add_location(svelte_scroller_foreground, file$6, 178, 1, 4140);
    			set_custom_element_data(svelte_scroller_outer, "class", "svelte-xdbafy");
    			add_location(svelte_scroller_outer, file$6, 171, 0, 3837);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "src/Sections/Section1.svelte";
    ...
    // (126:14) {#each $dots as { strokeWidth, opacity, cx, cy, cr, r, g, b}}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$5, 126, 16, 3128);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(126:14) {#each $dots as { strokeWidth, opacity, cx, cy, cr, r, g, b}}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(image, "href", "./image/moon-phases/" + (/*d*/ ctx[23] + 1) + ".jpg");
    			add_location(image, file$5, 141, 16, 3659);
    			add_location(g, file$5, 140, 14, 3639);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_foreground_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$5, 159, 8, 4251);
    			add_location(p1, file$5, 162, 8, 4299);
    			attr_dev(div0, "class", "step-text svelte-1ldyf6u");
    			add_location(div0, file$5, 158, 6, 4219);
    			attr_dev(section0, "data-section-id", "1");
    			attr_dev(section0, "class", "step svelte-1ldyf6u");
    			add_location(section0, file$5, 157, 4, 4170);
    			add_location(p2, file$5, 169, 8, 4568);
    			add_location(p3, file$5, 172, 8, 4616);
    			attr_dev(div1, "class", "step-text svelte-1ldyf6u");
    			add_location(div1, file$5, 168, 6, 4536);
    			attr_dev(section1, "data-section-id", "2");
    			attr_dev(section1, "class", "step svelte-1ldyf6u");
    			add_location(section1, file$5, 167, 4, 4487);
    			add_location(p4, file$5, 179, 8, 4833);
    			add_location(p5, file$5, 182, 8, 4881);
    			attr_dev(div2, "class", "step-text svelte-1ldyf6u");
    			add_location(div2, file$5, 178, 6, 4801);
    			attr_dev(section2, "data-section-id", "3");
    			attr_dev(section2, "class", "step svelte-1ldyf6u");
    			add_location(section2, file$5, 177, 4, 4752);
    			attr_dev(div3, "class", "scroller foreground svelte-1ldyf6u");
    			attr_dev(div3, "slot", "foreground");
    			add_location(div3, file$5, 156, 2, 4114);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$5, 98, 4, 2303);
    			add_location(li0, file$5, 102, 6, 2363);
    			add_location(li1, file$5, 105, 6, 2414);
    			add_location(li2, file$5, 108, 6, 2489);
    			add_location(ul, file$5, 101, 4, 2352);
    			add_location(article, file$5, 97, 2, 2289);
    			add_location(section, file$5, 96, 0, 2277);
    			if (!src_url_equal(script.src, script_src_value = "https://public.flourish.studio/resources/embed.js")) attr_dev(script, "src", script_src_value);
    			add_location(script, file$5, 116, 2, 2678);
    			attr_dev(div, "class", "flourish-embed flourish-table svelte-1ldyf6u");
    			attr_dev(div, "data-src", "visualisation/8040745");
    			add_location(div, file$5, 115, 0, 2599);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Section1> was created with unknown prop '${key}'`);
    	});
    ...
    class Section1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$5, create_fragment$5, safe_not_equal, { data: 13 }, null, [-1, -1]);
    		...
    		if (/*data*/ ctx[13] === undefined && !('data' in props)) {
    			console_1$1.warn("<Section1> was created without expected prop 'data'");
    		}
    	}
    ...
    const file$4 = "src/Sections/Section2.svelte";
    ...
    // (165:10) {#each $paths as { id, strokeWidth, opacity, y, r, g, b}}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$4, 165, 12, 4259);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(165:10) {#each $paths as { id, strokeWidth, opacity, y, r, g, b}}",
    		ctx
    	});
    ...
    function create_background_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g0, file$4, 163, 8, 4157);
    			attr_dev(g1, "transform", "translate(" + /*margin*/ ctx[7].l + ", " + /*margin*/ ctx[7].t + ")");
    			add_location(g1, file$4, 162, 6, 4099);
    			attr_dev(svg, "width", /*width*/ ctx[5]);
    			attr_dev(svg, "height", /*height*/ ctx[6]);
    			add_location(svg, file$4, 161, 4, 4070);
    			attr_dev(div, "class", "scroller background svelte-ac18uu");
    			attr_dev(div, "slot", "background");
    			add_location(div, file$4, 160, 2, 4014);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, svg);
    ...
    function create_foreground_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$4, 183, 8, 4802);
    			add_location(p1, file$4, 186, 8, 4850);
    			attr_dev(div0, "class", "step-text svelte-ac18uu");
    			add_location(div0, file$4, 182, 6, 4770);
    			attr_dev(section0, "data-section-id", "1");
    			attr_dev(section0, "class", "step svelte-ac18uu");
    			add_location(section0, file$4, 181, 4, 4721);
    			add_location(p2, file$4, 193, 8, 5040);
    			add_location(p3, file$4, 196, 8, 5088);
    			attr_dev(div1, "class", "step-text svelte-ac18uu");
    			add_location(div1, file$4, 192, 6, 5008);
    			attr_dev(section1, "data-section-id", "2");
    			attr_dev(section1, "class", "step svelte-ac18uu");
    			add_location(section1, file$4, 191, 4, 4959);
    			add_location(p4, file$4, 203, 8, 5330);
    			add_location(p5, file$4, 206, 8, 5378);
    			attr_dev(div2, "class", "step-text svelte-ac18uu");
    			add_location(div2, file$4, 202, 6, 5298);
    			attr_dev(section2, "data-section-id", "3");
    			attr_dev(section2, "class", "step svelte-ac18uu");
    			add_location(section2, file$4, 201, 4, 5249);
    			attr_dev(div3, "class", "scroller foreground svelte-ac18uu");
    			attr_dev(div3, "slot", "foreground");
    			add_location(div3, file$4, 180, 2, 4665);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div3, anchor);
    			append_dev(div3, section0);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$4, 124, 4, 3252);
    			add_location(li0, file$4, 131, 10, 3390);
    			add_location(ul0, file$4, 130, 8, 3375);
    			add_location(li1, file$4, 128, 6, 3323);
    			add_location(li2, file$4, 139, 10, 3565);
    			add_location(li3, file$4, 142, 10, 3633);
    			add_location(ul1, file$4, 138, 8, 3550);
    			add_location(li4, file$4, 136, 6, 3475);
    			add_location(li5, file$4, 150, 10, 3793);
    			add_location(ul2, file$4, 149, 8, 3778);
    			add_location(li6, file$4, 147, 6, 3720);
    			add_location(ul3, file$4, 127, 4, 3312);
    			add_location(article0, file$4, 123, 2, 3238);
    			add_location(section, file$4, 122, 0, 3226);
    			add_location(p0, file$4, 215, 2, 5524);
    			add_location(p1, file$4, 218, 2, 5765);
    			add_location(article1, file$4, 214, 0, 5512);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Section2> was created with unknown prop '${key}'`);
    	});
    ...
    class Section2 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$4, create_fragment$4, safe_not_equal, { data: 10 }, null, [-1, -1]);
    		...
    		if (/*data*/ ctx[10] === undefined && !('data' in props)) {
    			console_1.warn("<Section2> was created without expected prop 'data'");
    		}
    	}
    ...
    const file$3 = "src/Sections/Section3.svelte";
    ...
    // (28:28)       <Section1 data={moonAccidentsD}
    function create_then_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(28:28)       <Section1 data={moonAccidentsD}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 24, 0, 707);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['moonAccidentsD', 'mercuryDelaysD'];
    	...
    	return [moonAccidentsD, mercuryDelaysD, promise];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance, create_fragment, safe_not_equal, { moonAccidentsD: 0, mercuryDelaysD: 1 });
